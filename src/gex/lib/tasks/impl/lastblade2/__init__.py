'''Implementation of lastblade2: The Last Blade 2 on Steam and Amazon'''
import logging
import os
...
class TheLastBlade2Task(BaseTask):
    '''Implements lastblade2: The Last Blade 2 (GOG)'''
    _task_name = "lastblade2"
    _title = "The Last Blade 2"
    _details_markdown = '''
This task covers The Last Blade 2 from GOG.
